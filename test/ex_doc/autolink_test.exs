defmodule ExDoc.AutolinkTest do
  ...
  describe "doc/3" do
    ...
    test "elixir kernel function" do
      assert autolinked(~t"Kernel.+/2") == "https://hexdocs.pm/elixir/Kernel.html#+/2"
      assert autolinked(~t"+/2") == "https://hexdocs.pm/elixir/Kernel.html#+/2"
      assert autolinked(~t"+/2", app: :elixir, current_module: String) == "Kernel.html#+/2"
      assert autolinked(~t"+/2", app: :elixir, current_module: Kernel) == "#+/2"
    end

    test "elixir special form" do
      assert autolinked(~t"import/2") ==
